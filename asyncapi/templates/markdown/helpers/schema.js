// copy from https://github.com/asyncapi/markdown-template/blob/master/helpers/schema.js
...
export class SchemaHelpers {
    ...
    if (type === "array") {
      ...
      if (Array.isArray(items)) {
        ...
        if (additionalItems === true) {
          ...
          }, ...optional&lt;${SchemaCustomTypes.ANY}&gt;&gt;`;
        }
      ...
      return `array&lt;${
        this.toSchemaType(items) || SchemaCustomTypes.UNKNOWN
      }&gt;`;
    }
    return type;
  }
  ...
  static parametersToSchema(parameters) {
    ...
    const json = {
      ...
      properties: parameters.reduce((obj, parameter) => {
        ...
        obj[String(parameterName)] = Object.assign(
          {},
        ...
        obj[String(parameterName)][this.extParameterLocation] =
          parameter.location();
        return obj;
      }, {}),
  ...
  static humanizeNumberRangeConstraint(min, exclusiveMin, max, exclusiveMax) {
  ...
  static humanizeMultipleOfConstraint(multipleOf) {
  ...
  static humanizeRangeConstraint(description, min, max) {
    let stringRange;
